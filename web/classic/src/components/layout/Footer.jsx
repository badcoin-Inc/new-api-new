...
const FooterBar = () => {
  ...
  const customFooter = useMemo(
    () => (
      <footer className='relative h-auto py-6 md:py-8 px-6 md:px-24 w-full flex flex-col items-center justify-between overflow-hidden'>
  ...
  return (
    <div className='w-full'>
      {footer ? (
        <footer className='relative h-auto py-2 px-6 md:px-24 w-full flex items-center justify-center overflow-hidden'>
