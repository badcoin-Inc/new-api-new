...
export const GroupRatioForm = memo(function GroupRatioForm({
  ...
  const renderGeneratedTokenGroupFields = (appRows: number) => (
    <>
      <FormField
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel>{t('App-specific default token groups')}</FormLabel>
            <FormControl>
              <Textarea
                rows={appRows}
                placeholder={
      ...
      <Form {...form}>
        ...
        {editMode === 'visual' ? (
          <div className='space-y-6'>
            ...
            {renderGeneratedTokenGroupFields(4)}
          </div>
        ) : (
          <SettingsForm onSubmit={form.handleSubmit(onSave)}>
            ...
            />
            {renderGeneratedTokenGroupFields(6)}
          </SettingsForm>
        )}
      </Form>
    </div>
